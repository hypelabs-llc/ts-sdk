...
<p align="center">
  <a href="https://www.npmjs.com/package/@hypelabs/partner-sdk"><img src="https://img.shields.io/npm/v/@hypelabs/partner-sdk?color=cb3837&label=npm" /></a>
  <a href="https://www.npmjs.com/package/@hypelabs/partner-sdk"><img src="https://img.shields.io/npm/dt/@hypelabs/partner-sdk?color=cb3837&label=Downloads" /></a>
...
```bash
npm install @hypelabs/partner-sdk
```
...
```ts
import { createPartnerClient } from "@hypelabs/partner-sdk";
